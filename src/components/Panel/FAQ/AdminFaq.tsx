                    ...
                    {data.map((item: any) => {
                        return <div className=' bg-blue-300 rounded-[30px] px-[30px] py-[10px] mb-2'>
                            <div className='flex flex-row justify-between'>
                                ...
                                <div>
                                    <span className='cursor-pointer' onClick={() => updateFaq(item.key)}>
                                        <EditOutlined color='gray'/>
                                    </span>
                                    <span className='cursor-pointer' onClick={() => deleteFaq(item.key)}>
                                        <DeleteOutlined color='#a2a2a2'/>
                                    </span>
                                </div>
                            </div>
